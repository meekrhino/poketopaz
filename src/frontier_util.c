...
{
    SPECIES_KIPPOROK, SPECIES_UNICROWN, SPECIES_TYPHIDNA,
    SPECIES_KURANPU, SPECIES_JIRACHI, 0xFFFF
};
...
u8 GetFrontierBrainStatus(void)
{
    ...
    default:
        ...
        // Some increment of the gold streak is reached
            ...
            && (winStreak - frontierBrain->trainerType.frontierBrain.streakAppearances[1]) % frontierBrain->trainerType.frontierBrain.streakAppearances[2] == 0)
            status = FRONTIER_BRAIN_STREAK_LONG;
        break;
    }
