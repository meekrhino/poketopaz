...
void TryPutTodaysRivalTrainerOnAir(void)
{
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        show->rivalTrainer.dexCount = GetPokedexCount(FLAG_GET_CAUGHT);
...
u8 CheckForPlayersHouseNews(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup != MAP_GROUP(MAP_NEO_BAY_PLAYERS_HOUSE_2F))
...
void GetMomOrDadStringForTVMessage(void)
{
    ...
    {
        if (gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_NEO_BAY_PLAYERS_HOUSE_1F)) {
