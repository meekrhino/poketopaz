...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DOLPHURE - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_FIRANT - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_PYROON - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_PYREIGN - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_FINCHERP - 1]    = ANIM_V_SLIDE_SLOW,
    ...
    [SPECIES_JALSIDA - 1]     = ANIM_GROW_VIBRATE,
