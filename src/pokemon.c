...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_CELSINGE - 1]    = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_FAHRAMANE - 1]   = ANIM_V_STRETCH,
    [SPECIES_KELVOYANT - 1]   = ANIM_GLOW_ORANGE,
    [SPECIES_ECHOISE - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
    [SPECIES_MERMEIDON - 1]   = ANIM_SHRINK_GROW,
    [SPECIES_DOLPHURE - 1]    = ANIM_SWING_CONCAVE,
    [SPECIES_FIRANT - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_PYROON - 1]      = ANIM_GLOW_ORANGE,
    [SPECIES_PYREIGN - 1]     = ANIM_LUNGE_GROW,
    [SPECIES_FINCHERP - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SHORT_SLOW,
    [SPECIES_GASHAWK - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_EAGLAIR - 1]     = ANIM_FRONT_FLIP,
    [SPECIES_MOGEL - 1]       = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_FIRREL - 1]      = ANIM_H_SHAKE,
    [SPECIES_AMPURE - 1]      = ANIM_FLASH_YELLOW,
    [SPECIES_OHMURE - 1]      = ANIM_SWING_CONCAVE_FAST,
    ...
    [SPECIES_CANILEAF - 1]    = ANIM_SHRINK_GROW,
    [SPECIES_WOLVINE - 1]     = ANIM_SHRINK_GROW_VIBRATE_SLOW,
    ...
    [SPECIES_SPIDREAM - 1]    = ANIM_SWING_CONVEX,
    [SPECIES_ARACHMARE - 1]   = ANIM_GROW_VIBRATE,
    [SPECIES_PINECO - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_FORRETRESS - 1]  = ANIM_V_SHAKE,
    [SPECIES_EMBEAR - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_GRIZLARE - 1]    = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_AMPHAROS - 1]    = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_WHISPAW - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_COROONA - 1]     = ANIM_V_STRETCH,
    [SPECIES_MOOCALF - 1]     = ANIM_V_STRETCH,
    [SPECIES_TAUROS - 1]      = ANIM_V_SHAKE_TWICE,
    [SPECIES_MILTANK - 1]     = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_INFLARE - 1]     = ANIM_V_SQUISH_BOUNCE_SPIN,
    [SPECIES_INGERO - 1]      = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_GRIFIC - 1]      = ANIM_SWING_CONVEX_SLOW_REVERSE,
    [SPECIES_GRYPHONIC - 1]   = ANIM_V_STRETCH,
    [SPECIES_BARKUB - 1]      = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [SPECIES_GROWLITHE - 1]   = ANIM_BACK_AND_LUNGE,
    [SPECIES_ARCANINE - 1]    = ANIM_H_VIBRATE,
    [SPECIES_VIXUN - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_VULPIX - 1]      = ANIM_V_STRETCH,
    [SPECIES_NINETALES - 1]   = ANIM_V_SHAKE,
    [SPECIES_KONDRIA - 1]     = ANIM_RAPID_H_HOPS,
    [SPECIES_WHISMUR - 1]     = ANIM_H_SLIDE,
    [SPECIES_LOUDRED - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_EXPLOUD - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_STRIBRA - 1]     = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_MURKROW - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HARSKROW - 1]    = ANIM_H_STRETCH,
    [SPECIES_JACKALANT - 1]   = ANIM_SWING_CONCAVE,
    [SPECIES_PHANTERN - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_SKALLOY - 1]     = ANIM_H_STRETCH,
    [SPECIES_SKARMORY - 1]    = ANIM_V_STRETCH,
    [SPECIES_DUSKULL - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_DUSCLOPS - 1]    = ANIM_H_VIBRATE,
    [SPECIES_CASCADET - 1]    = ANIM_V_SLIDE_WOBBLE_SMALL,
    [SPECIES_VENONAT - 1]     = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_VENOMOTH - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_SMALLARD - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MALLARGE - 1]    = ANIM_GROW_IN_STAGES,
    ...
    [SPECIES_ZANTILIDAE - 1]  = ANIM_V_SHAKE,
    [SPECIES_SEVIPER - 1]     = ANIM_V_STRETCH,
    [SPECIES_PYTHANG - 1]     = ANIM_CIRCLE_INTO_BG_SHAKE,
    ...
    [SPECIES_TRILLOGILL - 1]  = ANIM_H_STRETCH,
    [SPECIES_TIDASALE - 1]    = ANIM_H_PIVOT,
    [SPECIES_QUIISORD - 1]    = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_TSUNALL - 1]     = ANIM_H_SHAKE,
    ...
    [SPECIES_SLOWPRIEST - 1]  = ANIM_GROW_VIBRATE_RISE_FALL,
    [SPECIES_REMORAID - 1]    = ANIM_V_JUMPS_SMALL,
    [SPECIES_OCTILLERY - 1]   = ANIM_V_STRETCH,
    [SPECIES_PHANTASOMO - 1]  = ANIM_V_SLIDE_SLOW,
    [SPECIES_SMEARGLE - 1]    = ANIM_H_JUMPS,
    [SPECIES_SERAPH - 1]      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DUNSPARCE - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ABSOL - 1]       = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_ABYSSUS - 1]     = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_EQUILL - 1]      = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_TELLURE - 1]     = ANIM_GROW_STUTTER_TWICE,
    [SPECIES_CORPHISH - 1]    = ANIM_V_SHAKE,
    [SPECIES_CRAWDAUNT - 1]   = ANIM_GROW_VIBRATE,
    [SPECIES_DITTO - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_GARGOTH - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRAGOYLE - 1]    = ANIM_H_SHAKE,
    [SPECIES_TOGEPI - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_TOGETIC - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CIRROFT - 1]     = ANIM_SHRINK_GROW_SLOW,
    [SPECIES_CUMULOFT - 1]    = ANIM_V_SLIDE_SLOW,
    [SPECIES_DESTADO - 1]     = ANIM_CIRCLE_INTO_BG,
    [SPECIES_FROSTORM - 1]    = ANIM_H_STRETCH,
    [SPECIES_NIMBOLT - 1]     = ANIM_FLASH_YELLOW,
    [SPECIES_DRAKODO - 1]     = ANIM_LUNGE_GROW,
    ...
    [SPECIES_ILLUMEON - 1]    = ANIM_V_STRETCH,
    [SPECIES_CHIARAME - 1]    = ANIM_H_STRETCH,
    [SPECIES_SERBERINE - 1]   = ANIM_V_SHAKE,
    [SPECIES_MISDREAVUS - 1]  = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_ENGIL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BENENGIL - 1]    = ANIM_GROW_VIBRATE,
    [SPECIES_DUVAL - 1]       = ANIM_H_STRETCH,
    [SPECIES_MALDUVAL - 1]    = ANIM_LUNGE_GROW,
    [SPECIES_QWILFISH - 1]    = ANIM_GROW_IN_STAGES,
    [SPECIES_TANGELA - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_TROPIUS - 1]     = ANIM_V_SHAKE,
    [SPECIES_BRONTOGON - 1]   = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_BLITZFAUST - 1]  = ANIM_H_SHAKE,
    [SPECIES_VILEPHIST - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RHYHORN - 1]     = ANIM_V_SHAKE,
    [SPECIES_RHYDON - 1]      = ANIM_SHRINK_GROW,
    [SPECIES_TORKOAL - 1]     = ANIM_V_STRETCH,
    [SPECIES_SINESTRIL - 1]   = ANIM_SWING_CONCAVE,
    [SPECIES_MALISTRIL - 1]   = ANIM_H_SHAKE,
    [SPECIES_SCYTHER - 1]     = ANIM_H_VIBRATE,
    [SPECIES_SCIZOR - 1]      = ANIM_H_VIBRATE,
    [SPECIES_BAKURGE - 1]     = ANIM_FLASH_YELLOW,
    [SPECIES_LAPRAS - 1]      = ANIM_V_STRETCH,
    [SPECIES_SIRENE - 1]      = ANIM_V_STRETCH,
    [SPECIES_IGLONIA - 1]     = ANIM_H_STRETCH,
    [SPECIES_STANTLER - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CARIBRISK - 1]   = ANIM_GROW_VIBRATE,
    [SPECIES_HUSKII - 1]      = ANIM_V_STRETCH,
    [SPECIES_TUNDROLF - 1]    = ANIM_GROW_VIBRATE,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_ZANTILIDAE - 1] = 20,
    [SPECIES_TRILLOGILL - 1] = 40,
    [SPECIES_TSUNALL - 1]    = 70,
    [SPECIES_SLOWPRIEST - 1] = 10,
    [SPECIES_PHANTASOMO - 1] = 10,
    [SPECIES_DUNSPARCE - 1]  = 10,
    [SPECIES_EQUILL - 1]     = 10,
    [SPECIES_TELLURE - 1]    = 10,
    [SPECIES_GARGOTH - 1]    = 30,
    [SPECIES_CRAGOYLE - 1]   = 45,
    [SPECIES_CHIARAME - 1]   = 20,
    [SPECIES_QWILFISH - 1]   = 39,
    [SPECIES_MALISTRIL - 1]  = 15,
    [SPECIES_SCIZOR - 1]     = 19,
    [SPECIES_BAKURGE - 1]    = 10,
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_PLAYER_N] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_PlayerN,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_BRADLEY] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Bradley,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_ALISA] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Alisa,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_SIMON] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Simon,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
};
