...
static const u16 sSpecialBattleStrings[] =
{
    ...
    STRINGID_PKMNHITWITHRECOIL, STRINGID_PKMNCRASHED, STRINGID_PKMNHITSELFINSTEAD, TABLE_END
};
...
void BattleTv_SetDataBasedOnString(u16 stringId)
{
    ...
    case STRINGID_PKMNSCATTEREDASHES:
    ...
    case STRINGID_PKMNHITSELFINSTEAD:
...
#define move arg1
    case PTS_REFLECT:
        ...
        if (IS_MOVE_PHYSICAL(gBattleMoves[move]) && power != 0 && tvPtr->side[defSide].reflectMonId != 0)
        {
    ...
    case PTS_LIGHT_SCREEN:
        ...
        if (IS_MOVE_SPECIAL(gBattleMoves[move]) && power != 0 && tvPtr->side[defSide].lightScreenMonId != 0)
        {
