...
static void AshGrassPerStepCallback(u8 taskId)
{
    ...
    if (MetatileBehavior_IsAshGrass(MapGridGetMetatileBehaviorAt(x, y)))
    {
        ...
        else if(MapGridGetMetatileIdAt(x, y) == METATILE_ChartreeForest_AshGrass)
            StartAshFieldEffect(x, y, METATILE_ChartreeForest_NormalGrass, 4);
        else if(MapGridGetMetatileIdAt(x, y) == METATILE_ChartreeForest_AshGrass_2)
            StartAshFieldEffect(x, y, METATILE_ChartreeForest_NormalGrass_2, 4);
        else if(MapGridGetMetatileIdAt(x, y) == METATILE_ChartreeForest_AshGrass_3)
            StartAshFieldEffect(x, y, METATILE_ChartreeForest_NormalGrass_3, 4);
        else if(MapGridGetMetatileIdAt(x, y) == METATILE_ChartreeForest_AshGrass_4)
            StartAshFieldEffect(x, y, METATILE_ChartreeForest_NormalGrass_4, 4);
        else if(MapGridGetMetatileIdAt(x, y) == METATILE_ChartreeForest_AshGrass_5)
            StartAshFieldEffect(x, y, METATILE_ChartreeForest_NormalGrass_5, 4);
        else
