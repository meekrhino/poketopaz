...
static const u8 sCreditsText_PkmnTopazVersion[]               = _("Pokémon Emerald Version");
...
static const struct CreditsEntry sCreditsEntry_PkmnEmeraldVersion[]             = { 7,  TRUE, sCreditsText_PkmnTopazVersion};
