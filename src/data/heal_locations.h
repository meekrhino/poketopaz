static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SUNSET_VILLAGE - 1] = {MAP_GROUP(SUNSET_VILLAGE), MAP_NUM(SUNSET_VILLAGE), 27, 23},
    ...
    [HEAL_LOCATION_ROOTHAVEN_CITY - 1] = {MAP_GROUP(ROOTHAVEN_CITY), MAP_NUM(ROOTHAVEN_CITY), 20, 25},
