static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEO_BAY - 1] = {MAP_GROUP(NEO_BAY), MAP_NUM(NEO_BAY), 34, 24},
    [HEAL_LOCATION_SOFTWIND_CITY - 1] = {MAP_GROUP(SOFTWIND_CITY), MAP_NUM(SOFTWIND_CITY), 23, 46},
    [HEAL_LOCATION_SUNSET_VILLAGE - 1] = {MAP_GROUP(SUNSET_VILLAGE), MAP_NUM(SUNSET_VILLAGE), 27, 25},
    [HEAL_LOCATION_CRANEWING_CITY - 1] = {MAP_GROUP(CRANEWING_CITY), MAP_NUM(CRANEWING_CITY), 29, 21},
    [HEAL_LOCATION_MISTVALE_CITY - 1] = {MAP_GROUP(MISTVALE_CITY), MAP_NUM(MISTVALE_CITY), 44, 28},
    [HEAL_LOCATION_ROOTHAVEN_CITY - 1] = {MAP_GROUP(ROOTHAVEN_CITY), MAP_NUM(ROOTHAVEN_CITY), 43, 23},
    [HEAL_LOCATION_HOLLOWLOG_CITY - 1] = {MAP_GROUP(HOLLOWLOG_CITY), MAP_NUM(HOLLOWLOG_CITY), 15, 10},
    [HEAL_LOCATION_KALYPSO_CITY - 1] = {MAP_GROUP(KALYPSO_CITY), MAP_NUM(KALYPSO_CITY), 20, 20},
};
