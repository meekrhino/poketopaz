...
{
    {
        ...
        .species = {SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO, SPECIES_PINECO},
        .id = 0,
...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_AFTERBURN] = FALSE,
    [MOVE_ALPHA_SHOCK] = FALSE,
    [MOVE_BETA_FLAME] = FALSE,
    [MOVE_GAMMA_SPORE] = FALSE,
    [MOVE_DELTA_WAVE] = FALSE,
    [MOVE_AMBUSH] = FALSE,
    [MOVE_BLACK_HOLE] = FALSE,
    [MOVE_BLINDING_RAY] = FALSE,
    [MOVE_BRIGHT_SLASH] = FALSE,
    [MOVE_CHERRY_BOMB] = FALSE,
    [MOVE_CASCADE] = FALSE,
    [MOVE_CALM_WIND] = FALSE,
    [MOVE_BURNOUT] = FALSE,
    [MOVE_BUG_BURN] = FALSE,
    [MOVE_CINDERS] = FALSE,
    [MOVE_COLD_WIND] = FALSE,
    [MOVE_CREVASSE] = FALSE,
    [MOVE_DOOM_SCYTHE] = FALSE,
    [MOVE_DRAGON_GALE] = FALSE,
    [MOVE_ENLIGHTEN] = FALSE,
    [MOVE_EQUILIBRIUM] = FALSE,
    [MOVE_FAULT_LINE] = FALSE,
    [MOVE_FIREBALL] = FALSE,
    [MOVE_FIRE_BATH] = FALSE,
    [MOVE_FLORAL_STORM] = FALSE,
    [MOVE_FLASH_PUNCH] = FALSE,
    [MOVE_FRICTION] = FALSE,
    [MOVE_HOLY_FIST] = FALSE,
    [MOVE_ICICLE_WHIP] = FALSE,
    [MOVE_INITIATIVE] = FALSE,
    [MOVE_FIRESTORM] = FALSE,
    [MOVE_LIGHT_WAVE] = FALSE,
    [MOVE_MAGIC_DUST] = FALSE,
    [MOVE_MARIONETTE] = FALSE,
    [MOVE_MAGNET_BLAST] = FALSE,
    [MOVE_MEGAFRICTION] = FALSE,
    [MOVE_MYSTIC_POWER] = FALSE,
    [MOVE_NIGHTFALL] = FALSE,
    [MOVE_ORION_SWORD] = FALSE,
    [MOVE_POLARIZE] = FALSE,
    [MOVE_PURIFY] = FALSE,
    [MOVE_QUICKBOLT ] = FALSE,
    [MOVE_RIPTIDE] = FALSE,
    [MOVE_ROCKET_PUNCH] = FALSE,
    [MOVE_SCORN] = FALSE,
    [MOVE_SERENADE] = FALSE,
    [MOVE_SHINE] = FALSE,
    [MOVE_SMITE] = FALSE,
    [MOVE_SOOTHE_SONG] = FALSE,
    [MOVE_SOUL_BURN] = FALSE,
    [MOVE_SPECTRAL_RAY] = FALSE,
    [MOVE_SOLAR_FLARE] = FALSE,
    [MOVE_STATRONOME] = FALSE,
    [MOVE_SQUALL] = FALSE,
    [MOVE_SPIRAL_KICK] = FALSE,
    [MOVE_SPIKE_WALL] = FALSE,
    [MOVE_TERRA_STRIKE] = FALSE,
    [MOVE_TIDAL_WAVE] = FALSE,
    [MOVE_UMBRAGE] = FALSE,
    [MOVE_VENOM_STRIKE] = FALSE,
    [MOVE_WINDWHISTLE] = FALSE,
    [MOVE_WATER_WALL] = FALSE,
    [MOVE_WRATH] = FALSE,
    [MOVE_ZIGZAG] = FALSE,
    [MOVE_FLARE] = FALSE,
    [MOVE_GRAVITY_BOND] = FALSE,
    [MOVE_FOCUS_SIGHT] = FALSE,
    [MOVE_IRON_FIST] = FALSE,
    [MOVE_OVERLOAD] = FALSE,
    [MOVE_SACRIFICE] = FALSE,
    [MOVE_TEMPER] = FALSE,
    [MOVE_TEMPEST] = FALSE,
    [MOVE_DIVE_BOMB] = FALSE,
};
