...
// For whatever reason FRONTIER_MON_PINECO is in a different order than _1 _3 and _4
...
{
    FRONTIER_MONS_BUG_CATCHER_1_EXTRA(PINECO, PINECO)
};
...
{
    FRONTIER_MONS_EXPERT_2A(PINECO)
};

const u16 gBattleFrontierTrainerMons_Weston[] =
{
    FRONTIER_MONS_EXPERT_2B(PINECO)
};

const u16 gBattleFrontierTrainerMons_Jasper[] =
{
    FRONTIER_MONS_EXPERT_2C(PINECO)
};
...
{
    FRONTIER_MONS_PSYCHIC_2A(PINECO)
};

const u16 gBattleFrontierTrainerMons_Stanly[] =
{
    FRONTIER_MONS_PSYCHIC_2B(PINECO)
};

const u16 gBattleFrontierTrainerMons_Dario[] =
{
    FRONTIER_MONS_PSYCHIC_2C(PINECO)
};
