const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_AFTERBURN] = _("Aferburn"),
    [MOVE_ALPHA_SHOCK] = _("Alpha Shock"),
    [MOVE_BETA_FLAME] = _("Beta Flame"),
    [MOVE_GAMMA_SPORE] = _("Gamma Spore"),
    [MOVE_DELTA_WAVE] = _("Delta Wave"),
    [MOVE_AMBUSH] = _("Ambush"),
    [MOVE_BLACK_HOLE] = _("Black Hole"),
    [MOVE_BLINDING_RAY] = _("Blinding Ray"),
    [MOVE_BRIGHT_SLASH] = _("Bright Slash"),
    [MOVE_CHERRY_BOMB] = _("Cherry Bomb"),
    [MOVE_CASCADE] = _("Cascade"),
    [MOVE_CALM_WIND] = _("Calm Wind"),
    [MOVE_BURNOUT] = _("Burnout"),
    [MOVE_BUG_BURN] = _("Bug Burn"),
    [MOVE_CINDERS] = _("Cinders"),
    [MOVE_COLD_WIND] = _("Cold Wind"),
    [MOVE_CREVASSE] = _("Crevasse"),
    [MOVE_DOOM_SCYTHE] = _("Doom Scythe"),
    [MOVE_DRAGON_GALE] = _("Dragon Gale"),
    [MOVE_ENLIGHTEN] = _("Enlighten"),
    [MOVE_EQUILIBRIUM] = _("Equilibrium"),
    [MOVE_FAULT_LINE] = _("Fault Line"),
    [MOVE_FIREBALL] = _("Fireball"),
    [MOVE_FIRE_BATH] = _("Fire Bath"),
    [MOVE_FLORAL_STORM] = _("Floral Storm"),
    [MOVE_FLASH_PUNCH] = _("Flash Punch"),
    [MOVE_FRICTION] = _("Friction"),
    [MOVE_HOLY_FIST] = _("Holy Fist"),
    [MOVE_ICICLE_WHIP] = _("Icicle Whip"),
    [MOVE_INITIATIVE] = _("Initiative"),
    [MOVE_FIRESTORM] = _("Firestorm"),
    [MOVE_LIGHT_WAVE] = _("Light Wave"),
    [MOVE_MAGIC_DUST] = _("Magic Dust"),
    [MOVE_MARIONETTE] = _("Marionette"),
    [MOVE_MAGNET_BLAST] = _("Magnet Blast"),
    [MOVE_MEGAFRICTION] = _("Megafriction"),
    [MOVE_MYSTIC_POWER] = _("Mystic Power"),
    [MOVE_NIGHTFALL] = _("Nightfall"),
    [MOVE_ORION_SWORD] = _("Orion Sword"),
    [MOVE_POLARIZE] = _("Polarize"),
    [MOVE_PURIFY] = _("Purify"),
    [MOVE_QUICKBOLT ] = _("Quickbolt"),
    [MOVE_RIPTIDE] = _("Riptide"),
    [MOVE_ROCKET_PUNCH] = _("Rocket Punch"),
    [MOVE_SCORN] = _("Scorn"),
    [MOVE_SERENADE] = _("Serenade"),
    [MOVE_SHINE] = _("Shine"),
    [MOVE_SMITE] = _("Smite"),
    [MOVE_SOOTHE_SONG] = _("Soothe Song"),
    [MOVE_SOUL_BURN] = _("Soul Burn"),
    [MOVE_SPECTRAL_RAY] = _("Spectral Ray"),
    [MOVE_SOLAR_FLARE] = _("Solar Flare"),
    [MOVE_STATRONOME] = _("Statronome"),
    [MOVE_SQUALL] = _("Squall"),
    [MOVE_SPIRAL_KICK] = _("Spiral Kick"),
    [MOVE_SPIKE_WALL] = _("Spike Wall"),
    [MOVE_TERRA_STRIKE] = _("Terra Strike"),
    [MOVE_TIDAL_WAVE] = _("Tidal Wave"),
    [MOVE_UMBRAGE] = _("Umbrage"),
    [MOVE_VENOM_STRIKE] = _("Venom Strike"),
    [MOVE_WINDWHISTLE] = _("Windwhistle"),
    [MOVE_WATER_WALL] = _("Water Wall"),
    [MOVE_WRATH] = _("Wrath"),
    [MOVE_ZIGZAG] = _("Zigzag"),
    [MOVE_FLARE] = _("Flare"),
    [MOVE_GRAVITY_BOND] = _("Gravity Bond"),
    [MOVE_FOCUS_SIGHT] = _("Focus Sight"),
    [MOVE_IRON_FIST] = _("Iron Fist"),
    [MOVE_OVERLOAD] = _("Overload"),
    [MOVE_SACRIFICE] = _("Sacrifice"),
    [MOVE_TEMPER] = _("Temper"),
