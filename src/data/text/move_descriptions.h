...
static const u8 sGravityBondDescription[] = _(
    "Magnetically secures the\n"
    "user to the ground.");

static const u8 sFocusSightDescription[] = _(
    "User trains its eyes on the\n"
    "foe, raising its accuracy.");

static const u8 sIronFistDescription[] = _(
    "Strikes with a fist as hard\n"
    "as iron. May lower DEFENSE.");

static const u8 sOverloadDescription[] = _(
    "Allows a full-power attack,\n"
    "but sharply lowers SP. ATK.");

static const u8 sSacrificeDescription[] = _(
    "User sacrifices its life\n"
    "essence to restore another.");

static const u8 sTemperDescription[] = _(
    "User goes on a fiery,\n"
    "uncontrolled tantrum.");

static const u8 sTempestDescription[] = _(
    "A blistering windstorm\n"
    "ravages opponents.");

static const u8 sDiveBombDescription[] = _(
    "Aerial attack at breakneck\n"
    "speed. Damage user on miss.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_AFTERBURN - 1] = sAfterburnDescription,
    [MOVE_ALPHA_SHOCK - 1] = sAlphaShockDescription,
    [MOVE_BETA_FLAME - 1] = sBetaFlameDescription,
    [MOVE_GAMMA_SPORE - 1] = sGammaSporeDescription,
    [MOVE_DELTA_WAVE - 1] = sDeltaWaveDescription,
    [MOVE_AMBUSH - 1] = sAmbushDescription,
    [MOVE_BLACK_HOLE - 1] = sBlackHoleDescription,
    [MOVE_BLINDING_RAY - 1] = sBlindingRayDescription,
    [MOVE_BRIGHT_SLASH - 1] = sBrightSlashDescription,
    [MOVE_CHERRY_BOMB - 1] = sCherryBombDescription,
    [MOVE_CASCADE - 1] = sCascadeDescription,
    [MOVE_CALM_WIND - 1] = sCalmWindDescription,
    [MOVE_BURNOUT - 1] = sBurnoutDescription,
    [MOVE_BUG_BURN - 1] = sBugBurnDescription,
    [MOVE_CINDERS - 1] = sCindersDescription,
    [MOVE_COLD_WIND - 1] = sColdWindDescription,
    [MOVE_CREVASSE - 1] = sCrevasseDescription,
    [MOVE_DOOM_SCYTHE - 1] = sDoomScytheDescription,
    [MOVE_DRAGON_GALE - 1] = sDragonGaleDescription,
    [MOVE_ENLIGHTEN - 1] = sEnlightenDescription,
    [MOVE_EQUILIBRIUM - 1] = sEquilibriumDescription,
    [MOVE_FAULT_LINE - 1] = sFaultLineDescription,
    [MOVE_FIREBALL - 1] = sFireballDescription,
    [MOVE_FIRE_BATH - 1] = sFireBathDescription,
    [MOVE_FLORAL_STORM - 1] = sFloralStormDescription,
    [MOVE_FLASH_PUNCH - 1] = sFlashPunchDescription,
    [MOVE_FRICTION - 1] = sFrictionDescription,
    [MOVE_HOLY_FIST - 1] = sHolyFistDescription,
    [MOVE_ICICLE_WHIP - 1] = sIcicleWhipDescription,
    [MOVE_INITIATIVE - 1] = sInitiativeDescription,
    [MOVE_FIRESTORM - 1] = sInfernoDescription,
    [MOVE_LIGHT_WAVE - 1] = sLightWaveDescription,
    [MOVE_MAGIC_DUST - 1] = sMagicDustDescription,
    [MOVE_MARIONETTE - 1] = sMarionetteDescription,
    [MOVE_MAGNET_BLAST - 1] = sMagnetBlastDescription,
    [MOVE_MEGAFRICTION - 1] = sMegafrictionDescription,
    [MOVE_MYSTIC_POWER - 1] = sMysticPowerDescription,
    [MOVE_NIGHTFALL - 1] = sNightfallDescription,
    [MOVE_ORION_SWORD - 1] = sOrionSwordDescription,
    [MOVE_POLARIZE - 1] = sPolarizeDescription,
    [MOVE_PURIFY - 1] = sPurifyDescription,
    [MOVE_QUICKBOLT  - 1] = sQuickboltDescription,
    [MOVE_RIPTIDE - 1] = sRiptideDescription,
    [MOVE_ROCKET_PUNCH - 1] = sRocketPunchDescription,
    [MOVE_SCORN - 1] = sScornDescription,
    [MOVE_SERENADE - 1] = sSerenadeDescription,
    [MOVE_SHINE - 1] = sShineDescription,
    [MOVE_SMITE - 1] = sSmiteDescription,
    [MOVE_SOOTHE_SONG - 1] = sSootheSongDescription,
    [MOVE_SOUL_BURN - 1] = sSoulBurnDescription,
    [MOVE_SPECTRAL_RAY - 1] = sSpectralRayDescription,
    [MOVE_SOLAR_FLARE - 1] = sSolarFlareDescription,
    [MOVE_STATRONOME - 1] = sStatronomeDescription,
    [MOVE_SQUALL - 1] = sSquallDescription,
    [MOVE_SPIRAL_KICK - 1] = sSpiralKickDescription,
    [MOVE_SPIKE_WALL - 1] = sSpikeWallDescription,
    [MOVE_TERRA_STRIKE - 1] = sTerraStrikeDescription,
    [MOVE_TIDAL_WAVE - 1] = sTidalWaveDescription,
    [MOVE_UMBRAGE - 1] = sUmbrageDescription,
    [MOVE_VENOM_STRIKE - 1] = sVenomStrikeDescription,
    [MOVE_WINDWHISTLE - 1] = sWindwhistleDescription,
    [MOVE_WATER_WALL - 1] = sWaterWallDescription,
    [MOVE_WRATH - 1] = sWrathDescription,
    [MOVE_ZIGZAG - 1] = sZigzagDescription,
    [MOVE_FLARE - 1] = sFlareDescription,
    [MOVE_GRAVITY_BOND - 1] = sGravityBondDescription,
    [MOVE_FOCUS_SIGHT - 1] = sFocusSightDescription,
    [MOVE_IRON_FIST - 1] = sIronFistDescription,
    [MOVE_OVERLOAD - 1] = sOverloadDescription,
    [MOVE_SACRIFICE - 1] = sSacrificeDescription,
    [MOVE_TEMPER - 1] = sTemperDescription,
    [MOVE_TEMPEST - 1] = sTempestDescription,
