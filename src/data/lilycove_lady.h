...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_PINECO,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_PINECO,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_PINECO,
    [CONTEST_CATEGORY_SMART]  = SPECIES_PINECO,
    [CONTEST_CATEGORY_TOUGH]  = SPECIES_PINECO
};
