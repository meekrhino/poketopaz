...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MURKROW]    = {{EVO_LEVEL_ITEM, ITEM_UMBRA_CREST, SPECIES_HARSKROW}},
    ...
    [SPECIES_ZANGOOSE]   = {{EVO_LEVEL_ITEM, ITEM_RIVALRY_ORB, SPECIES_ZANTILIDAE}},
    [SPECIES_SEVIPER]    = {{EVO_LEVEL_ITEM, ITEM_RIVALRY_ORB, SPECIES_PYTHANG}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            ...
                            {EVO_LEVEL_ITEM, ITEM_BLESSED_ANKH, SPECIES_SLOWPRIEST}},
    [SPECIES_REMORAID]   = {{EVO_LEVEL, 25, SPECIES_OCTILLERY}},
    [SPECIES_ABSOL]      = {{EVO_LEVEL_ITEM, ITEM_UMBRA_CREST, SPECIES_ABYSSUS}},
    ...
    [SPECIES_CIRROFT]    = {{EVO_LOCATION_SAND, 30, SPECIES_DESTADO},
                            {EVO_LOCATION_SNOW, 30, SPECIES_FROSTORM},
                            {EVO_LOCATION_FACTORY, 30, SPECIES_NIMBOLT},
                            {EVO_LEVEL, 30, SPECIES_CUMULOFT}},
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON},
                            {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_UMBREON},
                            {EVO_LEVEL_ITEM, ITEM_SOLAR_CELL, SPECIES_ILLUMEON}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_LEVEL_ITEM, 29, ITEM_METAL_COAT}},
    ...
    [SPECIES_CACTURNE]   = {{EVO_LEVEL_ITEM, ITEM_UMBRA_CREST, SPECIES_CACKINGE}},
