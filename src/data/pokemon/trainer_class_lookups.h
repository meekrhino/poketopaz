const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_PLAYER_N] = TRAINER_PIC_PLAYER_N,
};

const u8 gFacilityClassToTrainerClass[] =
{
    [FACILITY_CLASS_HIKER] = TRAINER_CLASS_HIKER,
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_CLASS_ORION_DEFENDER,
    ...
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_CLASS_ORION_DEFENDER,
    [FACILITY_CLASS_SWIMMER_M] = TRAINER_CLASS_SWIMMER_M,
    [FACILITY_CLASS_MAGMA_GRUNT_M] = TRAINER_CLASS_TEAM_ROCKET,
    ...
    [FACILITY_CLASS_MAGMA_GRUNT_F] = TRAINER_CLASS_TEAM_ROCKET,
    ...
    [FACILITY_CLASS_PLAYER_N] = TRAINER_CLASS_PKMN_TRAINER_3,
};
