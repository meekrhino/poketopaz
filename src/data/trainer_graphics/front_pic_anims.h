...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LEADER_FROY] = sAnims_LeaderFroy,
    [TRAINER_PIC_LEADER_THERMA] = sAnims_LeaderTherma,
    ...
    [TRAINER_PIC_SIMON] = sAnims_Simon,
    [TRAINER_PIC_PLAYER_N] = sAnims_PlayerN,
    [TRAINER_PIC_BRADLEY] = sAnims_Bradley,
    [TRAINER_PIC_ALISA] = sAnims_Alisa,
