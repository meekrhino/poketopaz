const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_PLAYER_N] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_FROY, gTrainerFrontPic_LeaderFroy, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_THERMA, gTrainerFrontPic_LeaderTherma, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(PLAYER_N, gTrainerFrontPic_PlayerN, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BRADLEY, gTrainerFrontPic_Bradley, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SIMON, gTrainerFrontPic_Simon, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ALISA, gTrainerFrontPic_Alisa, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ORION_GRUNT_M, gTrainerFrontPic_OrionGruntM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ORION_GRUNT_F, gTrainerFrontPic_OrionGruntF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(WOLSEY, gTrainerFrontPic_Wolsey, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SHOOK, gTrainerFrontPic_Shook, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ALLARD, gTrainerFrontPic_Allard, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BALFOUR, gTrainerFrontPic_Balfour, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(PLAYER_N, gTrainerPalette_PlayerN),
