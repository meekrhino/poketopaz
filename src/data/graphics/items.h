...
const u32 gItemIcon_TuskFossil[] = INCBIN_U32("graphics/items/icons/tusk_fossil.4bpp.lz");
const u32 gItemIconPalette_HoennFossil[] = INCBIN_U32("graphics/items/icon_palettes/hoenn_fossil.gbapal.lz");
const u32 gItemIcon_FangFossil[] = INCBIN_U32("graphics/items/icons/fang_fossil.4bpp.lz");
