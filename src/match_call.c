...
{
    {
        .trainerId = TRAINER_ALISA_1_VENAP,
        .unused = 0,
    ...
    {
        .trainerId = TRAINER_BRADLEY_NEOBAY_2_ECHOISE,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
...
static bool32 MapAllowsMatchCall(void)
{
    ...
    if (gMapHeader.regionMapSectionId == MAPSEC_SEDCINI_CITY
...
static const struct MultiTrainerMatchCallText sMultiTrainerMatchCallTexts[] =
{
    ...
    { .trainerId = TRAINER_WANDA, .text = gText_Gabby },
...
void BufferPokedexRatingForMatchCall(u8 *destStr)
{
    ...
    numSeen = GetPokedexCount(FLAG_GET_SEEN);
    numCaught = GetPokedexCount(FLAG_GET_CAUGHT);
