...
const struct CompressedSpriteSheet gBallSpriteSheets[POKEBALL_COUNT] =
{
    ...
    [BALL_DUNE]    = {gBallGfx_Dune,    384, GFX_TAG_DUNEBALL},
    [BALL_ORION]   = {gBallGfx_Orion,   384, GFX_TAG_ORIONBALL},
    [BALL_ROCKET]  = {gBallGfx_Rocket,  384, GFX_TAG_ROCKETBALL},
    [BALL_SOLAR]   = {gBallGfx_Solar,   384, GFX_TAG_SOLARBALL},
    [BALL_STORM]   = {gBallGfx_Storm,   384, GFX_TAG_STORMBALL},
    [BALL_VINE]    = {gBallGfx_Vine,    384, GFX_TAG_VINEBALL},
};
...
const struct CompressedSpritePalette gBallSpritePalettes[POKEBALL_COUNT] =
{
    ...
    [BALL_DUNE]    = {gBallPal_Dune,    GFX_TAG_DUNEBALL},
    [BALL_ORION]   = {gBallPal_Orion,   GFX_TAG_ORIONBALL},
    [BALL_ROCKET]  = {gBallPal_Rocket,  GFX_TAG_ROCKETBALL},
    [BALL_SOLAR]   = {gBallPal_Solar,   GFX_TAG_SOLARBALL},
    [BALL_STORM]   = {gBallPal_Storm,   GFX_TAG_STORMBALL},
    [BALL_VINE]    = {gBallPal_Vine,    GFX_TAG_VINEBALL},
};
