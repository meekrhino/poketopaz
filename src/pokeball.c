...
const struct SpriteTemplate gBallSpriteTemplates[POKEBALL_COUNT] =
{
    ...
    {
        .tileTag = GFX_TAG_DUNEBALL,
        .paletteTag = GFX_TAG_DUNEBALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_ORIONBALL,
        .paletteTag = GFX_TAG_ORIONBALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_ROCKETBALL,
        .paletteTag = GFX_TAG_ROCKETBALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_STORMBALL,
        .paletteTag = GFX_TAG_STORMBALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_VINEBALL,
        .paletteTag = GFX_TAG_VINEBALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
