...
#define GFX_TAG_DUNE_BALL    55012
#define GFX_TAG_ORION_BALL   55013
#define GFX_TAG_ROCKET_BALL  55014
#define GFX_TAG_SOLAR_BALL   55015
#define GFX_TAG_STORM_BALL   55016
#define GFX_TAG_VINE_BALL    55017
...
const struct CompressedSpriteSheet gBallSpriteSheets[POKEBALL_COUNT] =
{
    ...
    [BALL_DUNE]    = {gBallGfx_Dune,    384, GFX_TAG_DUNE_BALL},
    [BALL_ORION]   = {gBallGfx_Orion,   384, GFX_TAG_ORION_BALL},
    [BALL_ROCKET]  = {gBallGfx_Rocket,  384, GFX_TAG_ROCKET_BALL},
    [BALL_SOLAR]   = {gBallGfx_Solar,   384, GFX_TAG_SOLAR_BALL},
    [BALL_STORM]   = {gBallGfx_Storm,   384, GFX_TAG_STORM_BALL},
    [BALL_VINE]    = {gBallGfx_Vine,    384, GFX_TAG_VINE_BALL},
};
...
const struct CompressedSpritePalette gBallSpritePalettes[POKEBALL_COUNT] =
{
    ...
    [BALL_DUNE]    = {gBallPal_Dune,    GFX_TAG_DUNE_BALL},
    [BALL_ORION]   = {gBallPal_Orion,   GFX_TAG_ORION_BALL},
    [BALL_ROCKET]  = {gBallPal_Rocket,  GFX_TAG_ROCKET_BALL},
    [BALL_SOLAR]   = {gBallPal_Solar,   GFX_TAG_SOLAR_BALL},
    [BALL_STORM]   = {gBallPal_Storm,   GFX_TAG_STORM_BALL},
    [BALL_VINE]    = {gBallPal_Vine,    GFX_TAG_VINE_BALL},
};
...
const struct SpriteTemplate gBallSpriteTemplates[POKEBALL_COUNT] =
{
    ...
    {
        .tileTag = GFX_TAG_DUNE_BALL,
        .paletteTag = GFX_TAG_DUNE_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_ORION_BALL,
        .paletteTag = GFX_TAG_ORION_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_SOLAR_BALL,
        .paletteTag = GFX_TAG_SOLAR_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_STORM_BALL,
        .paletteTag = GFX_TAG_STORM_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
    ...
    {
        .tileTag = GFX_TAG_VINE_BALL,
        .paletteTag = GFX_TAG_VINE_BALL,
        .oam = &sBallOamData,
        .anims = sBallAnimSequences,
        .images = NULL,
        .affineAnims = sAffineAnim_BallRotate,
