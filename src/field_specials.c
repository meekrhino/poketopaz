        ...
        graphicsId == OBJ_EVENT_GFX_RIVAL_MAY_NORMAL)
    {
        ...
        if (obj != OBJECT_EVENTS_COUNT)
        {
            ...
            case OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL:
                LoadPalette(gObjectEventPal_PlayerN, OBJ_PLTT_ID(adjustedPaletteNum), PLTT_SIZE_4BPP);
                break;
...
static void PCTurnOnEffect_SetMetatile(s16 isScreenOn, s8 dx, s8 dy)
{
    ...
    if (isScreenOn)
    {
        ...
        if (gSpecialVar_0x8004 == PC_LOCATION_OTHER)
            ...
            metatileId = METATILE_BrendansMaysHouse_PlayerPC_Off;
    }
    else
    {
        ...
        if (gSpecialVar_0x8004 == PC_LOCATION_OTHER)
            ...
            metatileId = METATILE_BrendansMaysHouse_PlayersPC_On;
    }
...
void SetTrickHouseNuggetFlag(void)
{
    ...
    u16 flag = FLAG_HIDDEN_ITEM_ROUTE_203_GARDEN;
    *specVar = flag;
    FlagSet(flag);
}
