...
{
    [SPECIES_VENAP]      = BACK_ANIM_V_SHAKE,
    [SPECIES_TRAPLENT]   = BACK_ANIM_V_SHAKE,
    [SPECIES_DIONARE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_CELSINGE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_FAHRAMANE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_KELVOYANT]  = BACK_ANIM_V_SHAKE,
    [SPECIES_ECHOISE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_MERMEIDON]  = BACK_ANIM_V_SHAKE,
    [SPECIES_DOLPHURE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_FIRANT]     = BACK_ANIM_V_SHAKE,
    [SPECIES_PYROON]     = BACK_ANIM_V_SHAKE,
    [SPECIES_PYREIGN]    = BACK_ANIM_V_SHAKE,
    [SPECIES_FINCHERP]   = BACK_ANIM_V_SHAKE,
    [SPECIES_GASHAWK]    = BACK_ANIM_V_SHAKE,
    [SPECIES_EAGLAIR]    = BACK_ANIM_V_SHAKE,
    [SPECIES_MOGEL]      = BACK_ANIM_V_SHAKE,
    [SPECIES_FIRREL]     = BACK_ANIM_V_SHAKE,
    [SPECIES_AMPURE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_OHMURE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_SANDSHREW]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SANDSLASH]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_LUPINE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_CANILEAF]   = BACK_ANIM_V_SHAKE,
    [SPECIES_WOLVINE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_JALSIDA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_SPOINK]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_GRUMPIG]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_SPIDREAM]   = BACK_ANIM_V_SHAKE,
    [SPECIES_ARACHMARE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_PINECO]     = BACK_ANIM_H_SHAKE,
    [SPECIES_FORRETRESS] = BACK_ANIM_V_SHAKE,
    [SPECIES_EMBEAR]     = BACK_ANIM_V_SHAKE,
    [SPECIES_GRIZLARE]   = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_WHISPAW]    = BACK_ANIM_V_SHAKE,
    [SPECIES_COROONA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_MOOCALF]    = BACK_ANIM_H_SLIDE,
    [SPECIES_TAUROS]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_MILTANK]    = BACK_ANIM_H_SLIDE,
    [SPECIES_INFLARE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_INGERO]     = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_ZANTILIDAE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SEVIPER]    = BACK_ANIM_V_STRETCH,
    [SPECIES_PYTHANG]    = BACK_ANIM_V_STRETCH,
    ...
    [SPECIES_TRILLOGILL] = BACK_ANIM_V_SHAKE,
    [SPECIES_TIDASALE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_QUIISORD]   = BACK_ANIM_V_SHAKE,
    [SPECIES_TSUNALL]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_SLOWPRIEST] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_REMORAID]   = BACK_ANIM_H_SLIDE,
    [SPECIES_OCTILLERY]  = BACK_ANIM_SHRINK_GROW,
    [SPECIES_PHANTASOMO] = BACK_ANIM_V_SHAKE,
    [SPECIES_SMEARGLE]   = BACK_ANIM_H_SLIDE,
    [SPECIES_SERAPH]     = BACK_ANIM_V_SHAKE,
    [SPECIES_DUNSPARCE]  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_ABSOL]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_ABYSSUS]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_EQUILL]     = BACK_ANIM_V_SHAKE,
    [SPECIES_TELLURE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_CORPHISH]   = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CRAWDAUNT]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DITTO]      = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GARGOTH]    = BACK_ANIM_V_SHAKE,
    [SPECIES_CRAGOYLE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_TOGEPI]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_TOGETIC]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CIRROFT]    = BACK_ANIM_V_SHAKE,
    [SPECIES_CUMULOFT]   = BACK_ANIM_V_SHAKE,
    [SPECIES_DESTADO]    = BACK_ANIM_V_SHAKE,
    [SPECIES_FROSTORM]   = BACK_ANIM_V_SHAKE,
    [SPECIES_NIMBOLT]    = BACK_ANIM_V_SHAKE,
    [SPECIES_DRAKODO]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_ILLUMEON]   = BACK_ANIM_V_SHAKE,
    [SPECIES_CHIARAME]   = BACK_ANIM_V_SHAKE,
    [SPECIES_SERBERINE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_MISDREAVUS] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ENGIL]      = BACK_ANIM_V_SHAKE,
    [SPECIES_BENENGIL]   = BACK_ANIM_V_SHAKE,
    [SPECIES_DUVAL]      = BACK_ANIM_V_SHAKE,
    [SPECIES_MALDUVAL]   = BACK_ANIM_V_SHAKE,
    [SPECIES_QWILFISH]   = BACK_ANIM_GROW_STUTTER,
    [SPECIES_TANGELA]    = BACK_ANIM_V_STRETCH,
    [SPECIES_TROPIUS]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_BRONTOGON]  = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_BLITZFAUST] = BACK_ANIM_V_SHAKE,
    [SPECIES_VILEPHIST]  = BACK_ANIM_V_SHAKE,
    [SPECIES_RHYHORN]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_RHYDON]     = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_TORKOAL]    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_SINESTRIL]  = BACK_ANIM_V_SHAKE,
    [SPECIES_MALISTRIL]  = BACK_ANIM_V_SHAKE,
    [SPECIES_SCYTHER]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_SCIZOR]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BAKURGE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_LAPRAS]     = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_SIRENE]     = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_IGLONIA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_STANTLER]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CARIBRISK]  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_HUSKII]     = BACK_ANIM_V_SHAKE,
    [SPECIES_TUNDROLF]   = BACK_ANIM_V_SHAKE,
    [SPECIES_WOLFROST]   = BACK_ANIM_V_SHAKE,
    [SPECIES_REEFRAIN]   = BACK_ANIM_V_SHAKE,
    [SPECIES_POLARA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_POLARICE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_MIRUST]     = BACK_ANIM_V_SHAKE,
    [SPECIES_FERRIAN]    = BACK_ANIM_V_SHAKE,
    [SPECIES_CACNEA]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_CACTURNE]   = BACK_ANIM_H_SHAKE,
    [SPECIES_CACKINGE]   = BACK_ANIM_H_SHAKE,
    [SPECIES_SCORCHION]  = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_MISTICADE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_KRAKLAW]    = BACK_ANIM_V_SHAKE,
    [SPECIES_LEORACLE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_KHAPHIX]    = BACK_ANIM_V_SHAKE,
    [SPECIES_FLINTUSK]   = BACK_ANIM_V_SHAKE,
    [SPECIES_METUSK]     = BACK_ANIM_V_SHAKE,
    [SPECIES_ALLUFANG]   = BACK_ANIM_V_SHAKE,
    [SPECIES_KUNAIGA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_PURIOR]     = BACK_ANIM_V_SHAKE,
    [SPECIES_GOLDRAKE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_AROWANA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_ATLAXA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_THORAXA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_ILLUMBRA]   = BACK_ANIM_V_SHAKE,
    [SPECIES_SNARLIGER]  = BACK_ANIM_V_SHAKE,
    [SPECIES_NOCTIGER]   = BACK_ANIM_V_SHAKE,
    [SPECIES_RAIGER]     = BACK_ANIM_V_SHAKE,
    [SPECIES_MATAKITE]   = BACK_ANIM_V_SHAKE,
    [SPECIES_TAGATI]     = BACK_ANIM_V_SHAKE,
    [SPECIES_NEICHIA]    = BACK_ANIM_V_SHAKE,
    [SPECIES_KURANPU]    = BACK_ANIM_V_SHAKE,
    [SPECIES_TYPHIDNA]   = BACK_ANIM_V_SHAKE,
    [SPECIES_UNICROWN]   = BACK_ANIM_V_SHAKE,
    [SPECIES_KIPPOROK]   = BACK_ANIM_V_SHAKE,
