...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ALISA_1_VENAP, TRAINER_FRANCIS, TRAINER_AMY_AND_ALLY, TRAINER_TRAVIS, TRAINER_GWEN, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_PERCY, TRAINER_JURGEN, TRAINER_WINSTON, TRAINER_ELI, TRAINER_SIERRA, MAP_ROUTE111),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_BRADLEY_NEOBAY_2_ECHOISE, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    {
    default:
    case SPECIES_TYPHIDNA:
        gBattleTypeFlags |= BATTLE_TYPE_GROUDON;
        CreateBattleStartTask(B_TRANSITION_GROUDON, MUS_VS_KYOGRE_GROUDON);
        break;
    case SPECIES_UNICROWN:
        gBattleTypeFlags |= BATTLE_TYPE_RAYQUAZA;
        CreateBattleStartTask(B_TRANSITION_RAYQUAZA, MUS_VS_RAYQUAZA);
        break;
    case SPECIES_KURANPU:
        CreateBattleStartTask(B_TRANSITION_BLUR, MUS_RG_VS_DEOXYS);
        break;
    case SPECIES_KRAKLAW:
...
void StartRegiBattle(void)
{
    ...
    switch (species)
    {
    case SPECIES_MATAKITE:
        transitionId = B_TRANSITION_REGIROCK;
        break;
    case SPECIES_TAGATI:
        transitionId = B_TRANSITION_REGICE;
        break;
    case SPECIES_NEICHIA:
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ORION_DEFENDER
