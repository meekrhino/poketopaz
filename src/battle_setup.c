...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ALISA_1_VENAP, TRAINER_FRANCIS, TRAINER_AMY_AND_ALLY, TRAINER_TRAVIS, TRAINER_GWEN, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_PERCY, TRAINER_JURGEN, TRAINER_WINSTON, TRAINER_ELI, TRAINER_SIERRA, ROUTE111),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_BRADLEY_NEOBAY_2_ECHOISE, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
