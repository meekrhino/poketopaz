...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_PORTWIND_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_LAYSAN_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_GALLEA_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CRANEWING_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ENCHESTRA_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ICTHYES_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CETACEA_TOWN] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SEDCINI_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_COLOSSUS_CITY] = MAPPOPUP_THEME_BRICK,
    ...
    [MAPSEC_ROUTE_205] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_206] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_207] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_208] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_209] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_ROUTE_222] = MAPPOPUP_THEME_UNDERWATER,
