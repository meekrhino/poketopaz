...
u8 DoFieldEndTurnEffects(void)
{
    ...
    do
    {
        ...
        case ENDTURN_DARKNESS:
            ...
            {
                if (!(gBattleWeather & B_WEATHER_DARKNESS_PERMANENT) && --gWishFutureKnock.weatherDuration == 0)
                {
        ...
        case ENDTURN_STILL_WEATHER:
            if (gBattleWeather & B_WEATHER_STILL)
            {
                if (--gWishFutureKnock.weatherDuration == 0)
                {
    ...
    while (gBattleStruct->turnEffectsBattlerId < gBattlersCount && gBattleStruct->turnEffectsTracker <= ENDTURN_BATTLER_COUNT)
    {
        ...
        else
        {
            ...
            case ENDTURN_ITEMS2:  // item effects again
                if (ItemBattleEffects(ITEMEFFECT_NORMAL, gActiveBattler, TRUE, 0))
                    effect++;
                gBattleStruct->turnEffectsTracker++;
                break;
    ...
    case 0:
        while (gBattleStruct->wishPerishSongBattlerId < gBattlersCount)
        {
             ...
             && gBattleMons[gActiveBattler].hp != 0)
            {
                ...
                else if (gWishFutureKnock.futureSightMove[gActiveBattler] == MOVE_TERRA_STRIKE)
    ...
    do
    {
        ...
        case 6:
            if (AbilityBattleEffects(ABILITYEFFECT_INTIMIDATE1, 0, 0, 0, 0)
             ...
             || ItemBattleEffects(ITEMEFFECT_NORMAL, 0, TRUE, 0)
    ...
    if (!(gBattleTypeFlags & BATTLE_TYPE_SAFARI)) // Why isn't that check done at the beginning?
    {
        ...
        case ABILITYEFFECT_ON_SWITCHIN: // 0
            ...
            case ABILITYEFFECT_SWITCH_IN_WEATHER:
                if (!(gBattleTypeFlags & BATTLE_TYPE_RECORDED))
                {
                    ...
                    case WEATHER_DARKNESS:
                        if (!(gBattleWeather & B_WEATHER_DARKNESS))
                        {
                            gBattleWeather = (B_WEATHER_DARKNESS_PERMANENT | B_WEATHER_DARKNESS_TEMPORARY);
            ...
            case ABILITY_ECLIPSE:
                if (!(gBattleWeather & B_WEATHER_DARKNESS_PERMANENT))
                {
                    gBattleWeather = (B_WEATHER_DARKNESS_PERMANENT | B_WEATHER_DARKNESS_TEMPORARY);
        ...
        case ABILITYEFFECT_ON_DAMAGE: // Contact abilities and Color Change
            ...
            case ABILITY_CUTE_CHARM:
                if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
                 ...
                 && gBattleMons[gBattlerAttacker].ability != ABILITY_EMPTY_HEAD
