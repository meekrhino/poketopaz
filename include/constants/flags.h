...
#define FLAG_RECEIVED_PAIL                   0x5E
...
#define FLAG_DEFEATED_RIVAL_NEOBAY_2         0x82
...
#define FLAG_CRANEWING_NPC_TRADE_COMPLETED   0x99
...
#define FLAG_RECEIVED_TM56                   0xA6
...
#define FLAG_RECEIVED_CRANEWING_CHARCOAL     0xE9
...
#define FLAG_RECEIVED_SOFTWIND_GREAT_BALL    0x101
...
#define FLAG_HIDDEN_ITEM_ROUTE_205_GRASS                     (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_ROUTE_205_FENCE                     (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_ROUTE_205_FLOWER_SHOP               (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_206_TREE                            (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_206_ROCK                            (FLAG_HIDDEN_ITEMS_START + 0x0D)
...
// Event Flags
#define FLAG_HIDE_NEO_BAY_MOM                                       0x2BC
...
#define FLAG_HIDE_NEO_BAY_BRADLEY                                   0x2CF
#define FLAG_HIDE_SUNSET_VILLAGE_WILLOW                             0x2D0
...
#define FLAG_ITEM_ROUTE_203_FARMHOUSE                               0x3EF
#define FLAG_ITEM_CHARTREE_FOREST_LEDGE                             0x3F0
#define FLAG_ITEM_CHARTREE_FOREST_CORNER                            0x3F1
...
#define FLAG_ITEM_ROUTE_206_FLOWERS                                 0x3F7
#define FLAG_ITEM_ROUTE_206_SOUTH                                   0x3F8
...
#define FLAG_DEFEATED_SOFTWIND_GYM                                  0x4F1
...
// Badges
#define FLAG_BADGE01_GET                             (SYSTEM_FLAGS + 0x7) // Cranewing (Froy)
#define FLAG_BADGE02_GET                             (SYSTEM_FLAGS + 0x8) // Softwind (Therma)
#define FLAG_BADGE03_GET                             (SYSTEM_FLAGS + 0x9) // Roothaven (Fernando)
#define FLAG_BADGE04_GET                             (SYSTEM_FLAGS + 0xA) // Kalypso (Jane)
#define FLAG_BADGE05_GET                             (SYSTEM_FLAGS + 0xB) // Gallea (Bella)
#define FLAG_BADGE06_GET                             (SYSTEM_FLAGS + 0xC) // Portwind (Tristan)
#define FLAG_BADGE07_GET                             (SYSTEM_FLAGS + 0xD) // Sedcini (Wolfe)
#define FLAG_BADGE08_GET                             (SYSTEM_FLAGS + 0xE) // Enchestra (Crys)
#define FLAG_BADGE09_GET                             (SYSTEM_FLAGS + 0xF) // Dynamo Gardens (Gerad)
#define FLAG_BADGE10_GET                             (SYSTEM_FLAGS + 0x10) // Skobeloff (Gerad)
#define FLAG_BADGE11_GET                             (SYSTEM_FLAGS + 0x11) // Saharan (Osiro)
#define FLAG_BADGE12_GET                             (SYSTEM_FLAGS + 0x12) // Aquapolis (Layla)
#define NUM_BADGES                                   (1 + FLAG_BADGE12_GET - FLAG_BADGE01_GET)

// Towns and Cities
#define FLAG_VISITED_NEOBAY_TOWN                    (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_SUNSET_VILLAGE                 (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_SOFTWIND_CITY                  (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_CRANEWING_CITY                 (SYSTEM_FLAGS + 0x16)
...
#define FLAG_VISITED_PETALBURG_CITY                 (SYSTEM_FLAGS + 0x1A)
#define FLAG_VISITED_SLATEPORT_CITY                 (SYSTEM_FLAGS + 0x1B)
#define FLAG_VISITED_MAUVILLE_CITY                  (SYSTEM_FLAGS + 0x1C)
#define FLAG_VISITED_RUSTBORO_CITY                  (SYSTEM_FLAGS + 0x1D)
#define FLAG_VISITED_FORTREE_CITY                   (SYSTEM_FLAGS + 0x1E)
#define FLAG_VISITED_LILYCOVE_CITY                  (SYSTEM_FLAGS + 0x1F)
#define FLAG_VISITED_MOSSDEEP_CITY                  (SYSTEM_FLAGS + 0x20)
#define FLAG_VISITED_SOOTOPOLIS_CITY                (SYSTEM_FLAGS + 0x21)
#define FLAG_VISITED_EVER_GRANDE_CITY               (SYSTEM_FLAGS + 0x22)

#define FLAG_IS_CHAMPION                            (SYSTEM_FLAGS + 0x23) // Seems to be related to linking.
#define FLAG_NURSE_UNION_ROOM_REMINDER              (SYSTEM_FLAGS + 0x24)
