...
enum {
    ...
    HEAL_LOCATION_NEO_BAY,
    HEAL_LOCATION_SOFTWIND_CITY,
    HEAL_LOCATION_SUNSET_VILLAGE,
    HEAL_LOCATION_CRANEWING_CITY,
    HEAL_LOCATION_MISTVALE_CITY,
    HEAL_LOCATION_ROOTHAVEN_CITY,
    HEAL_LOCATION_HOLLOWLOG_CITY,
    HEAL_LOCATION_KALYPSO_CITY,
};
