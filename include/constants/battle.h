...
#define BATTLE_TYPE_BRADLEY_TUTORIAL   (1 << 9) // Used in pokefirered as BATTLE_TYPE_OLD_MAN_TUTORIAL.
...
#define BATTLE_TYPE_RECORDED_INVALID        ((BATTLE_TYPE_LINK | BATTLE_TYPE_SAFARI | BATTLE_TYPE_FIRST_BATTLE                  \
                                             | BATTLE_TYPE_BRADLEY_TUTORIAL | BATTLE_TYPE_ROAMER | BATTLE_TYPE_EREADER_TRAINER    \
...
#define STATUS3_GRAVITY_BOUND           (1 << 21)
...
#define SIDE_STATUS_SACRIFICE_PEND   (1 << 14)
...
#define B_WEATHER_DARKNESS_TEMPORARY  (1 << 9)
#define B_WEATHER_DARKNESS_PERMANENT  (1 << 10)
#define B_WEATHER_DARKNESS            (B_WEATHER_DARKNESS_TEMPORARY | B_WEATHER_DARKNESS_PERMANENT)
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_DARKNESS)
#define B_WEATHER_STILL               (1 << 11)
...
#define MOVE_EFFECT_ROAR                55
#define MOVE_EFFECT_CURE_BURN           56
