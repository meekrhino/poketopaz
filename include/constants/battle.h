...
#define WEATHER_DARKNESS_TEMPORARY  (1 << 9)
#define WEATHER_DARKNESS_PERMANENT  (1 << 10)
#define WEATHER_DARKNESS_ANY        (WEATHER_DARKNESS_TEMPORARY | WEATHER_DARKNESS_PERMANENT)
#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_DARKNESS_ANY)
#define WEATHER_STILL               (1 << 11)
