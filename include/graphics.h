...
extern const u32 gBallGfx_Dune[];
extern const u32 gBallPal_Dune[];
extern const u32 gBallGfx_Orion[];
extern const u32 gBallPal_Orion[];
extern const u32 gBallGfx_Rocket[];
extern const u32 gBallPal_Rocket[];
extern const u32 gBallGfx_Solar[];
extern const u32 gBallPal_Solar[];
extern const u32 gBallGfx_Storm[];
extern const u32 gBallPal_Storm[];
extern const u32 gBallGfx_Vine[];
extern const u32 gBallPal_Vine[];
...
extern const u32 gTrainerFrontPic_LeaderFroy[];
extern const u32 gTrainerFrontPic_LeaderTherma[];
...
extern const u32 gTrainerFrontPic_PlayerN[];
extern const u32 gTrainerFrontPic_Bradley[];
extern const u32 gTrainerFrontPic_Simon[];
extern const u32 gTrainerFrontPic_Alisa[];
extern const u32 gTrainerFrontPic_OrionGruntM[];
extern const u32 gTrainerFrontPic_OrionGruntF[];
extern const u32 gTrainerFrontPic_Wolsey[];
extern const u32 gTrainerFrontPic_Shook[];
extern const u32 gTrainerFrontPic_Allard[];
extern const u32 gTrainerFrontPic_Balfour[];
...
extern const u32 gTrainerPalette_LeaderFroy[];
extern const u32 gTrainerPalette_LeaderTherma[];
...
extern const u32 gTrainerPalette_PlayerN[];
extern const u32 gTrainerPalette_Bradley[];
extern const u32 gTrainerPalette_Simon[];
extern const u32 gTrainerPalette_Alisa[];
extern const u32 gTrainerPalette_OrionGruntM[];
extern const u32 gTrainerPalette_OrionGruntF[];
extern const u32 gTrainerPalette_Wolsey[];
extern const u32 gTrainerPalette_Shook[];
extern const u32 gTrainerPalette_Allard[];
extern const u32 gTrainerPalette_Balfour[];
...
extern const u8 gTrainerBackPic_PlayerN[];
extern const u8 gTrainerBackPic_Bradley[];
extern const u8 gTrainerBackPic_Alisa[];
extern const u8 gTrainerBackPic_Simon[];
...
extern const u32 gItemIcon_PlainRock [];
extern const u32 gItemIconPalette_PlainRock[];
extern const u32 gItemIcon_MagicHerb [];
extern const u32 gItemIconPalette_MagicHerb[];
extern const u32 gItemIcon_MagmaRock [];
extern const u32 gItemIconPalette_MagmaRock[];
...
// Object event pals
extern const u16 gObjectEventPal_PlayerN[];
