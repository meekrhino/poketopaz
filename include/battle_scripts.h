...
extern const u8 BattleScript_StillWeatherEnds[];
extern const u8 BattleScript_StillWeatherContinues[];
extern const u8 BattleScript_SunlightContinues[];
extern const u8 BattleScript_SunlightFaded[];
extern const u8 BattleScript_DarknessContinues[];
extern const u8 BattleScript_DarknessLifted[];
...
extern const u8 BattleScript_CindersFree[];
extern const u8 BattleScript_MonTookFutureAttack[];
extern const u8 BattleScript_NoMovesLeft[];
extern const u8 BattleScript_DesperationActivates[];
...
extern const u8 BattleScript_MoveEffectRoar[];
...
extern const u8 BattleScript_BurnSoothed[];
extern const u8 BattleScript_MoveEffectSleep[];
extern const u8 BattleScript_YawnMakesAsleep[];
extern const u8 BattleScript_MoveEffectPoison[];
extern const u8 BattleScript_MoveEffectBurn[];
extern const u8 BattleScript_MoveEffectBurnSelf[];
...
extern const u8 BattleScript_CopycatActivates[];
...
extern const u8 BattleScript_AbilityRaiseStat[];
extern const u8 BattleScript_TookAttack[];
extern const u8 BattleScript_SturdyPreventsOHKO[];
extern const u8 BattleScript_DampStopsExplosion[];
extern const u8 BattleScript_MoveHPDrain_PPLoss[];
extern const u8 BattleScript_MoveHPDrain[];
extern const u8 BattleScript_MoveItemAbsorb_PPLoss[];
extern const u8 BattleScript_MoveItemAbsorb[];
...
extern const u8 BattleScript_SpikeWallDamage[];
...
extern const u8 BattleScript_ShrapnelRet[];
extern const u8 BattleScript_ToxicSlimeRet[];
