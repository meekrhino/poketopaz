...
types := normal fight flying poison ground rock bug ghost steel mystery fire water grass electric psychic ice dragon dark light
...
$(PKNAVOPTIONSGFXDIR)/options.4bpp: $(PKNAVOPTIONSGFXDIR)/caldera_kirant_map.4bpp \
